...
const APK_URL  = 'https://github.com/spetroearn/zip-replzipzipzipzip-1zipzip-1zip/releases/download/v2.1.10/SpetroEarn-v2.1.10.apk';
const fs    = require('fs');
const https = require('https');
const http  = require('http');

const APK_VER_PATH = path.join(__dirname, 'public', '.apk-version');
const APK_EXPECTED = 'v2.1.10';
